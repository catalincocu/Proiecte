...
<div id="panelwrap">
    ...
    <div class="submenu">
    <ul>
	<li><a href="administrareprofesori.php" class="selected">administrare profesori</a></li>
    <li><a href="adaugareprofesor.php">adaugare profesor</a></li>
    </ul>
    </div>                       
...
<table id="rounded-corner">
    ...
    <tbody>
		<?php
			if (($nr1 = InterogareSQL("select a.idprofesor,a.nume,a.prenume,b.denumirefacultate from gc_profesori a,gc_facultati b where a.idfacultate=b.idfacultate;",$rez1)) != 0)
					{
						for ($i=0;$i<$nr1;$i++)
							{
								...
								printf("<td><a href=\"administrareprofesori.php?sterge=1&idutilizator=%s\"><img src=\"images/trash.gif\" border=\"0\" /></a></td>",$linie1[0]);
								printf("</tr>");
							}
					} ?>
    </tbody>
