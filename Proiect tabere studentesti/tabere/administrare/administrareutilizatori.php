...
<div id="panelwrap">
    ...
    <div class="submenu">
    <ul>
	<li><a href="administrareutilizatori.php" class="selected">administrare utilizatori</a></li>
    <li><a href="adaugareutilizator.php">adaugare utilizator</a></li>
    </ul>
    </div>                       
 ...
 if (isset($_GET['sterge']))
			{
				...
				InterogareSQL("delete from pf_datepersonale where idutilizator=".$idutilizator.";",$rez1);
				InterogareSQL("delete from pf_utilizatori where idutilizator=".$idutilizator.";",$rez1);
			} ?>
    <div id="right_wrap">
...
<table id="rounded-corner">
    ...
    <tbody>
		<?php
			if (($nr1 = InterogareSQL("select a.idutilizator,a.username,b.nume,b.prenume,b.strada,b.nr,b.ap,b.telefon,b.email,b.localitate,b.judet from pf_utilizatori a,pf_datepersonale b where a.idutilizator=b.idutilizator;",$rez1)) != 0)
					{
						for ($i=0;$i<$nr1;$i++)
							{
								...
								printf("<td><a href=\"administrareutilizatori.php?editeaza=1&idutilizator=%s\"><img src=\"images/edit.png\" border=\"0\" /></a></td>",$linie1[0]);
								printf("<td><a href=\"administrareutilizatori.php?sterge=1&idutilizator=%s\"><img src=\"images/trash.gif\" border=\"0\" /></a></td>",$linie1[0]);
								printf("</tr>");
							}
					} ?>
    </tbody>
